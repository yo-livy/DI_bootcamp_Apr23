...
from films.views import HomePageView, FilmCreateView, DirectorCreateView, ReviewCreateView, FilmDeleteView, FilmDetailView
...
urlpatterns = [
    ...
    path('filmdetail/<int:pk>/', FilmDetailView.as_view(), name='detail')
]
